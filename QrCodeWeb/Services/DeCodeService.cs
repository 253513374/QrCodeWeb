...
namespace QrCodeWeb.Services
{
    public class DeCodeService
    {
        ...
        private List<RectPoints> GetPosotionDetectionPatternsPoints(Mat dilatemat, string name = "")
        {
            try
            {
        ...
        private Mat GetPosotionDetectionPatternsMat(Mat mat, List<RectPoints> rectPoints)
        {
        ...
        private int GetRotationAngle(List<RectPoints> rectPoints, out Point2f QRMatCenterPoint)
        {
